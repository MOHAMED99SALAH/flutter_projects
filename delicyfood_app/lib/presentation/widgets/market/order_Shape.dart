...
import '../../screens/market/details_OF_order.dart';

class Order_shape extends StatefulWidget {
  Order _order;

  static Color? color = Colors.white;

  Order_shape(this._order);

  @override
  State<Order_shape> createState() => _Order_shapeState();
}

class _Order_shapeState extends State<Order_shape> {
  @override
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return OrderDetails(
              widget._order.orderDetails, widget._order.orderID);
        }));
      },
      child: Material(
        child: Container(
